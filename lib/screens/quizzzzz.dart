          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Answers
                QuizOption(text: "A lion, because i felt brave!", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "A turtle, because i felt slow and quiet.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "A butterfly, because i felt light and happy.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "A monkey, because i felt playful and fun.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "A snake, because i didn't feel like talking to others.", onPressed: () => _goToNextPage(context)),
              ],
            ),
          ),
