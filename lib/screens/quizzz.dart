...
import 'package:bemaa_hack/screens/quizzzz.dart';
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Answers
                QuizOption(text: "I had fun with my friends.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "I didn't like something that happened.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "Someone made me feel upset.", onPressed: () => _goToNextPage(context)),

                QuizOption(text: "I don't know, just feeling this way.", onPressed: () => _goToNextPage(context)),
              ],
            ),
          ),
