...
import 'package:bemaa_hack/screens/quizzzzz.dart';
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Question
                Text(
                  "Did something at school make you feel this good today?",
                ...
                // Answers
                QuizOption(text: "Yes, playing at recess.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "Yes, i learned something new.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "Yes, i got along well with my friends.", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "I didn't go to school today", onPressed: () => _goToNextPage(context)),
                QuizOption(text: "No, i didn't feel very good at school.", onPressed: () => _goToNextPage(context)),
              ],
            ),
          ),
